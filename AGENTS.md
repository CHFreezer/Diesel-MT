...
- **Active workflow**: `work/plan/mvp-model-training.md`, `work/todo/mvp-model-training.md`, and `work/task/mvp-model-training/`. Historical execution reached TD-16B: TD-16A merged the hardware-configurable high-throughput trainer, and TD-16B trained the complete old 226,218-directed-record M0 through the authorized 15k early-stop boundary. Every checkpoint was rejected because the corpus has only 11,411 semantic/alignment groups and MASSIVE locale adaptation does not satisfy generic MT entity fidelity. TD-02/TD-03 schema v4 then published a generic-MT source bank, but the completed Hy-MT2 v3 generation failed its KFTT Japanese entity/terminology quality gate and remains rejected. A bounded 512-record, 20-route source-only A/B now favors DeepSeek V4 Flash direct translation (56 blind wins versus 22 for Hy-MT2, with 33 ties and 8 both bad); only a 2,048-record repeat is authorized, not full generation or TD-05 publication. TD-16 remains suspended and formal test remains unconsumed. The frozen M0/D0/D1, A/B, rejected generation, and old-M0 long-run evidence remain immutable. The frozen tokenizer already has both Chinese tags and must not be rebuilt. Do not reinterpret the random deployment checkpoint, M1 memorization checkpoint, TD-16 A/B candidates, or rejected old-M0 checkpoints as a trained final MVP model.
