...
| ---: | --- | --- | --- | --- | --- | --- |
| 1 | TD-01 | [冻结执行契约、目录与 Git 边界](td-01-execution-contract.md) | 无 | 无 | 无 | pending |
| 2 | TD-02 | [调研并锁定有界平行数据来源](td-02-dataset-research-and-lock.md) | TD-01 completed | TD-01 | TD-06、TD-09 | pending |
...
收敛主路径为 `TD-01 -> TD-02 -> TD-03 -> TD-04 -> TD-05`，之后同时汇合 teacher 分支 `TD-06 -> TD-07 -> TD-08`、student 分支 `TD-09 -> TD-10 -> TD-11 -> TD-12 -> TD-14` 和评测分支 `TD-09 -> TD-13`，再进入 `TD-15 -> TD-16 -> TD-17 -> TD-18`。
