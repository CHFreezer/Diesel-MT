...
- 生成合同：`configs/mvp_60m_teacher_generation.yaml`，规范 SHA-256 `aadd22506bbcb45da6d649846051af5c3cff175225c07dcb02d782da9011e1b0`。
- TD-03 紧凑 manifest SHA-256：`d1a200f28e00de25b9374d7d24244088046c16c32226f908ddae97ee26b15de1`。
...
- 正式运行根：`D:\Diesel-MT-Runtime\mvp60-data-v1\td04`；旧 M0/D1/TD-16 产物不覆盖。
...
当前正式生成由 `scripts/generate_mvp_60m_teacher.py generate --runtime-root D:\Diesel-MT-Runtime\mvp60-data-v1` 执行。完成前本 task 保持 `in progress`。
