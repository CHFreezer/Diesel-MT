...
- TD-02 schema v4 已冻结200,000条固定非Hant source、851条质量实收原生Hant、最多50,000条质量实收anchors和80/20 sampling mix；繁体技术≤15%、法律/政务≤20%，synthetic Hant不计原生。
...
- task：[MVP model training](../task/mvp-model-training/index.md)（历史执行到 TD-16B；TD-02 ability-first schema v4 completed，TD-03 source/anchors in progress；旧 TD-16 suspended）。
