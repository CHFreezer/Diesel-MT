...
- D0/D1 v1 的 complete manifest 只对既有 18 路身份成立。两条新增路线各固定 2,224 个候选，并已分别接受 2,213/2,207 条，通过质量、人工抽检、replay、provenance 和 test 隔离门槛。TD-15/TD-16 只允许消费冻结的 44,361 条 20 路 composite，不得用 D0 或单独的 D1 v1 代替。
...
- task：[MVP model training](../task/mvp-model-training/index.md)（TD-01～TD-08 completed；TD-09～TD-18 pending）。
