...
术语澄清：本归档 plan 中历史使用的“五语”表示 `eng_Latn`、`zho_Hans`、`zho_Hant`、`jpn_Jpan`、`kor_Hang` 五个 tokenizer 语言标签/语料桶，不表示五种产品语言。项目仍是中文、英文、日文、韩文四种产品语言；后续模型数据按 5 个标签桶、9 组无向平行语料和 18 个跨语言有向路由准备，不包含简繁互转。
