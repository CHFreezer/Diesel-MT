...
schema v2 完成标记为 `data/model/corpus/mvp/m0-manifest.json`，精简可提交证据为 [`m0-20route-acceptance.json`](../artifacts/model-training/reports/m0/m0-20route-acceptance.json)。完整质量分布、人工审查队列和复现逐文件明细保存在 `data/model/reports/`；v1 语料与证据明确归档在 `data/model/history/m0-v1/` 和 `artifacts/model-training/reports/m0/`。
...
- 目录规范化后的 TD-03/TD-04/M0 manifest SHA-256 分别为 `f90b861311f90791ca651f914340dac7c073f221ec39c0759d02b2d6aefaa636`、`f998d9b91a0aedf9900e683a01015d594187a6e15b66388260bf1ad30477f4c0`、`8626a11db593d0843427a5da187ba1e4bf27299d0bd06d8d5430d19918f7e427`。
...
以上哈希保留首次 M0 v1 构建的历史运行身份。目录规范化后，相同语料与审核结论显式发布在 `data/model/history/m0-v1/`；路径和报告命名进入身份哈希，因此当前 M0 manifest 为 `0d5a5d5039b110a92ce036db5dbaee5cd9fb9a491b24e9e467508bd5cfa3f482`，精简报告位于 `artifacts/model-training/reports/m0/m0-v1-acceptance.json`。
